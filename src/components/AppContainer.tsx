...
export class AppContainer extends React.Component<AppContainerProps, {}> {
    ...
    async componentDidMount() {
        ...
        const allCertificates = await Certificate.GET_ALL_CERTIFICATES(web3Service.blockchainProperties);

        this.props.actions.multipleCertificatesCreatedOrUpdated(allCertificates);
