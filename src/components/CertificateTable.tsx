    ...
    render() {
        ...
        const data = filteredEnrichedCertificateData.map((enrichedCertificateData: EnrichedCertificateData) => {
            ...
            return [
                ...
                enrichedCertificateData.producingAsset.country,
                new Date(enrichedCertificateData.certificate.creationTime * 1000).toDateString(),
                (enrichedCertificateData.certificate.coSaved / 100000000000000).toFixed(0),
        ...
        const TableHeader = [
            ...
            generateHeader('Owner', 90.84),
            generateHeader('Asset Type'),
            generateHeader('State'),
            generateHeader('Certification Date'),
            generateHeader('Incremental Credits (µg)'),
            generateHeader('Charge (kWh)', defaultWidth, true, true)
        ]
