...
export enum Actions {
    ...
    multipleCertificatesCreatedOrUpdated = 'MULTIPLE_CERTIFICATES_CREATED_OR_UPDATED',
...
export const multipleCertificatesCreatedOrUpdated = (certificates: Certificate[]) => ({
    type: Actions.multipleCertificatesCreatedOrUpdated,
    certificates
});
